...
class ChatItemTouchHelperCallback(
    ...
    private fun drawIcon(canvas: Canvas, itemView: View, dX: Float) {
        ...
        val icon = if(context.javaClass == ArchiveActivity::class.java) itemView.resources.getDrawable(R.drawable.ic_unarchive_black_24dp, context.theme)
            else itemView.resources.getDrawable(R.drawable.ic_archive_black_24dp, context.theme)
    ...
    private fun drawBackground(canvas: Canvas, itemView: View, dX: Float) {
        ...
        with(bgPaint){
            ...
            val swipeBgValue = TypedValue()
            theme.resolveAttribute(R.attr.colorSwipeBackground, swipeBgValue, true)
            //color = itemView.resources.getColor(R.color.color_primary_dark, theme)
            color = swipeBgValue.data
        }
